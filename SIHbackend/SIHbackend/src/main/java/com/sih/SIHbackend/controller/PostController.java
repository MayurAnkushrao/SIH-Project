...
public class PostController {
	...
	/*
	 * @PostMapping public ResponseEntity<PostResponse>
	 * createPost(@Valid @RequestBody PostRequest request // only the DTO parameter
	 * ) { try { PostResponse post = postService.createPost(request, null); // pass
	 * null or handle accordingly return
	 * ResponseEntity.status(HttpStatus.CREATED).body(post); } catch
	 * (RuntimeException e) { return ResponseEntity.badRequest().build(); } catch
	 * (Exception e) { return
