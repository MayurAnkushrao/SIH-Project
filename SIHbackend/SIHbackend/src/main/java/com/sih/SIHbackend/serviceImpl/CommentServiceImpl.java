...
public class CommentServiceImpl implements CommentService {
    ...
    public CommentResponse createComment(CommentRequest request) {
        ...
        String anonymousEmail = "anonymous@example.com";
        User anonymousUser = userRepository.findByEmail(anonymousEmail)
        	    .orElseGet(() -> {
        	        User user = new User();
        	        user.setEmail(anonymousEmail);
        	        user.setName("Anonymous");
        	        user.setPassword("anonymous"); // or any hashed placeholder password
        	       // user.setRole(Role.USER); // or suitable role, adjust import as needed
        ...
        comment.setUser(anonymousUser);  // assign anonymous user
    ...
    public List<CommentResponse> getCommentsByUserId(Long userId) {
        // Since no user linked, this may always return empty
    ...
    public boolean isCommentOwner(Long commentId, String userEmail) {
        // No authentication, return true or false as appropriate, here true to allow all
        return true;
    }
